...
public class DqwtPresenter implements TradeContract.DqwtPresenter {
    private TradeContract.DqwtView view;
    private DataSource dataRepository;

    public DqwtPresenter(DataSource dataRepository, TradeContract.DqwtView view) {
        this.view = view;
