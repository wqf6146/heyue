...
public class PayPasswordView extends LinearLayout implements View.OnClickListener, PasswordEditText.PasswordFullListener {
    ...
    public PayPasswordView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        ivBack.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                pwd1 = "";
                tvTip.setText("设置资金密码");
                mPasswordEditText.clearPassword();
            }
        });
    ...
    public void setTipTv(String text){
        tvTip.setText(text);
    }
    ...
    private String pwd1;
    private boolean bTwice=true;

    public void setbTwice(boolean bTwice) {
        this.bTwice = bTwice;
    }
