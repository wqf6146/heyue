...
public class DqccPresenter implements MyccContract.DqccPresenter {
    private MyccContract.DqccView view;
    private DataSource dataRepository;

    public DqccPresenter(DataSource dataRepository, MyccContract.DqccView view) {
        this.view = view;
