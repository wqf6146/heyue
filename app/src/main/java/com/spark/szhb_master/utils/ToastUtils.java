...
public class ToastUtils {
    ...
    private static void showCofirmDialog(final Activity activity) {
        ...
        dialog.title("提示").titleTextColor(activity.getResources().getColor(R.color.colorPrimary)).content(MyApplication.getApp().getString(R.string.login_tag)).setOnBtnClickL(
                new OnBtnClickL() {
                    @Override
