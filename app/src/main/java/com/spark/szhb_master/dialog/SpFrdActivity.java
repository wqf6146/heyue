...
public class SpFrdActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_share_frd);
...
//        initWechatShare();
        ...
        liner_frd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ShareUtils.shareWeb(SpFrdActivity.this, url, GlobalConstant.share_title +"--"+ GlobalConstant.share_des, GlobalConstant.share_description
        ...
        liner_wx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShareUtils.shareWeb(SpFrdActivity.this, url,  GlobalConstant.share_title, GlobalConstant.share_description,
                        GlobalConstant.logo_trea, R.mipmap.image_add, SHARE_MEDIA.WEIXIN);
                finish();
            }
        });
    }
