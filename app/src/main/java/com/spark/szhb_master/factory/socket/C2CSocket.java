...
//    public static final String ip ="52.80.242.238";//C2C 测试
//    public static final String ip ="39.104.175.209";//C2C  测试
    ...
    public static byte[] buildRequest(CMD cmd, byte[] body) {
        ...
        try {
            ...
            LogUtils.i("头部信息cmd:" + cmd.getCode() + ",length:" + length + ",sequenceId:" +
    ...
    public void dealResponse(final TCPCallback tcpCallback) throws IOException {
        ...
        LogUtils.i("返回cmd:" + code + ",length:" + length + ",sequenceId:" +
