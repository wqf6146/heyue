...
//        return FileProvider.getUriForFile(context, "com.spark.digiccy.fileprovider", file);

        return FileProvider.getUriForFile(context, "com.spark.szhb_master.fileprovidercay", file);
//        return FileProvider.getUriForFile(context, "com.spark.szhb.fileprovidercay", file);
    }
