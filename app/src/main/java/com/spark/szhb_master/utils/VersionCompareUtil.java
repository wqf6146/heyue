...
//        String v4 = "     ";
//        String v5 = "  联系  12  ";
//        System.out.println(firstName(v1));
//        System.out.println(firstName(v2));
//        System.out.println(firstName(v3));
//        System.out.println(firstName(v4)+"frist");
//        System.out.println(firstName(v5));
